...
| --- | --- | --- | --- | --- | --- |
| Net return, trailing 1Y (ann.) | **10.31%** (client data) as of 2025-12-31 [basis unconfirmed] | _blank: no figure within staleness window -- most recent reported figure is 275d old, beyond the 183d limit_ | **6.27%** (Med) as of 2025-12-31 | **8.72%** (Low) as of 2025-12-31 [net of fees: True; reinvested: True; nav total return] | _blank: not reported at this basis -- not reported by a mortgage reit; left blank rather than substituted with a near-metric on an incomparable basis_ |

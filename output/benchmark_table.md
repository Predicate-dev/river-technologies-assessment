...
| --- | --- | --- | --- | --- | --- |
| Net return, trailing 1Y (ann.) | **10.31%** (client data) as of 2025-12-31 [basis unconfirmed] | _blank: fund-level only; institutional figure not available -- net of fees: True; nport monthly chain linked; share class: fund level; institutional class required by deck footnote 3_ | **6.27%** (Med) as of 2025-12-31 [net of fees: True; chain linked annual total return; share class: Class I] | **8.72%** (Low) as of 2025-12-31 [net of fees: True; reinvested: True; nav total return] | _blank: not reported at this basis -- not reported by a mortgage reit; left blank rather than substituted with a near-metric on an incomparable basis_ |
